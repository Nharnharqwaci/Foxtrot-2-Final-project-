...
def load_models():
    try:
        ...
        required_files = [
            ...
            "scaler.joblib", 
            "best_isolation_forest_model.joblib"
        ]
        ...
        # Load models
        best_rf_model = joblib.load(MODEL_DIR / "best_random_forest_model.zip")
        iso_forest_scaler = joblib.load(MODEL_DIR / "scaler.joblib")
        best_iso_forest = joblib.load(MODEL_DIR / "best_isolation_forest_model.joblib")
